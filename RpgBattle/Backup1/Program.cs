...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        Character player = new Warrior("勇者", maxHp: 50, attackPower: 12, defense: 3);
        Character enemy = new Mage("スライム魔術師", maxHp: 40, attackPower: 10, defense: 1);
